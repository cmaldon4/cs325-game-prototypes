window.onload = function() {
    ...
    BasicGame.Boot.prototype = 
    {
		...
		create: function () 
		{
			...
			cagearray = [cagetopleft, cagetopmiddle, cagetopright, cagemiddleleft, cagemiddleright, cagemiddlemiddle, cagebottomleft, cagebottommiddle, cagebottomright];
			...
			animalarray = [cat, dog, hamster, pig, bunny, turtle, fox, panda, redpanda];
